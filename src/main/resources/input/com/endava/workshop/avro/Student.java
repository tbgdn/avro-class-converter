...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4549121963953278592L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.endava.workshop.avro\",\"fields\":[{\"name\":\"studentName\",\"type\":\"string\"},{\"name\":\"studentId\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public static com.endava.workshop.avro.Student.Builder newBuilder() {
    return new com.endava.workshop.avro.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.endava.workshop.avro.Student.Builder newBuilder(com.endava.workshop.avro.Student.Builder other) {
    return new com.endava.workshop.avro.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.endava.workshop.avro.Student.Builder newBuilder(com.endava.workshop.avro.Student other) {
    return new com.endava.workshop.avro.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.endava.workshop.avro.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.endava.workshop.avro.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.studentName)) {
        this.studentName = data().deepCopy(fields()[0].schema(), other.studentName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder setStudentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder setStudentId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder clearStudentId() {
      studentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.endava.workshop.avro.Student.Builder clearAge() {
